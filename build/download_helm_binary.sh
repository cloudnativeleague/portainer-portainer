...
if [ "${PLATFORM}" == 'linux' ]; then
  ...
  echo "download  https://get.helm.sh/${HELM_DIST}.tar.gz ..."
  curl -x "socks5h://127.0.0.1:1080" -o- "https://get.helm.sh/${HELM_DIST}.tar.gz" | tar -x -z --strip-components 1 "${PLATFORM}-${ARCH}/helm"
  mv "helm" "dist/helm"
  chmod +x "dist/helm"
